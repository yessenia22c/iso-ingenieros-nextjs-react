...
function PrincipalNavComponent() {
  ...
  return (
    <>
    <div className=' z-20 sm:z-20 w-full flex justify-center bg-red-800 p-2 sticky top-0'>
      <NavComponent></NavComponent>
      <ul className='flex w-full justify-end min-[500px]:hidden '>
        <li >
          <button onClick={ abrirCerrarAside }  className="justify-end text-white font-medium rounded-lg text-sm px-5 py-1" type="button" data-drawer-target="drawer-navigation" data-drawer-show="drawer-navigation" aria-controls="drawer-navigation">
